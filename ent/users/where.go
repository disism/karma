...
func HasDirsWith(preds ...predicate.Dirs) predicate.Users {
	return predicate.Users(func(s *sql.Selector) {
		step := newDirsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasSavesWith(preds ...predicate.Saves) predicate.Users {
	return predicate.Users(func(s *sql.Selector) {
		step := newSavesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
