...
// The DirsFunc type is an adapter to allow the use of ordinary
// function as Dirs mutator.
type DirsFunc func(context.Context, *ent.DirsMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DirsFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DirsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DirsMutation", m)
}
...
// The SavesFunc type is an adapter to allow the use of ordinary
// function as Saves mutator.
type SavesFunc func(context.Context, *ent.SavesMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SavesFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SavesMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SavesMutation", m)
}
