...
func (dd *DirsDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(dirs.Table, sqlgraph.NewFieldSpec(dirs.FieldID, field.TypeUint64))
...
func (ddo *DirsDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{dirs.Label}
	default:
		return nil
	}
}
